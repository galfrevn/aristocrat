...
import { AristocratDashboardSettingsCards } from '@/app/dashboard/(dashboard)/settings/components/cards';
import { SettingsAvatarForm } from '@/app/dashboard/(dashboard)/settings/components/forms/avatar';
import { SettingsPasswordForm } from '@/app/dashboard/(dashboard)/settings/components/forms/password';
import { SettingsProfileForm } from '@/app/dashboard/(dashboard)/settings/components/forms/profile';
import { AristocratDashboardSettingsSidebar } from '@/app/dashboard/(dashboard)/settings/components/sidebar';
