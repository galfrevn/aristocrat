...
import { useAristocratCourseGeneration } from '@/app/dashboard/(dashboard)/courses/components/generator/context';
import { AristocratCourseGenerationForm } from '@/app/dashboard/(dashboard)/courses/components/generator/form';
import {
